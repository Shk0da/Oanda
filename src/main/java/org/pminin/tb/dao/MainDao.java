...
public class MainDao {
	...
	private class CandleRowMapper implements RowMapper<Candle> {
		...
		public Candle mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			candle.setOpenBid(rs.getFloat(2));
			candle.setHighBid(rs.getFloat(3));
			candle.setLowBid(rs.getFloat(4));
			candle.setCloseBid(rs.getFloat(5));
			candle.setOpenAsk(rs.getFloat(6));
			candle.setHighAsk(rs.getFloat(7));
			candle.setLowAsk(rs.getFloat(8));
			candle.setCloseAsk(rs.getFloat(9));
			candle.setVolume(rs.getInt(10));
			candle.setComplete(rs.getBoolean(11));
			return candle;
		}
	}
	...
	private class FractalRowMapper implements RowMapper<Candle> {
		...
		public Candle mapRow(ResultSet rs, int rowNum) throws SQLException {
			...
			candle.setVolume(rs.getInt(10));
			candle.setComplete(rs.getBoolean(11));
			candle.setBroken(rs.getBoolean(12));
			candle.setBrokenTime(new DateTime(rs.getTimestamp(13), DateTimeZone.getDefault()));
			candle.setDirection(rs.getInt(14));
			return candle;
		}
	}
