...
import com.oanda.bot.domain.Order;
import com.oanda.bot.domain.Price;
import com.oanda.bot.domain.Step;
import com.oanda.bot.domain.Trade;
...
public class TradeActor extends UntypedAbstractActor {
	...
	private double adx(double[] inClose, double[] inLow, double[] inHigh) {
		...
		RetCode retCodeADX = talib.adx(0, inClose.length - 1, inHigh, inLow, inClose, 14, beginADX, lengthADX, outADX);
